    ...
    $(document).ready(function(){
      ...
      function addSuggestions(){
        ...
        if (!$('.suggestion').length){
            ...
            $('.suggestions').append('<div class=""><label for="message-text" class="control-label">Code Suggestions</label><div class="buttons nav"></div><div class="well"><code class="suggestion">...</code></div></div>');
