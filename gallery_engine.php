...
// FUNCTIONS
			...
			if(!function_exists(p_encodeEmail)){
			...
			if(!function_exists(p_getMemoryLimit)){
...
// GET CONFIG
			...
			$config['Images Dir'] = 'gallery';
			//$config['Images List'] = '';
			$config['Images List'] = $imageList;
