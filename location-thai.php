<?php $pageTitle = 'Location of the intensive in Partner Acrobatics'; ?>
<?php include('header.php');?>


<div class='content'>

<h1><?=$label[$curLang]['location_thai']?></h1>
...
<?=getContent('thai_location_subtitle');?>


<?=getContent('thai_location_main');?>
